...
<html>
    <head>
    <meta charset="utf-8">
        <title> SvSoft - Personal</title>
        <link href="presentacion/css/personal.css" rel="stylesheet" >
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-dark d-flex justify-content-center align-items-center flex-column a">
            <ul class="nav">
                ...
                <a class="btn btn-outline-light m-2 d-flex justify-content-center align-items-center" href="invernaderoAdministrador.php"> 
                ...
                <a class="btn btn-outline-light m-2 d-flex justify-content-center align-items-center" href="personalAdministrador.php"> 
...
<body>
<h1 class="Titulos">Datos del Personal</h1>
    <br></br>
    <div class="container">
        <a href="indexAdministrador.php" class="btn btn--1">Volver</a>
		</div>
    ...
    <table class="table table-light table-striped table-striped table-hover" style="font-family: sans-serif;">
		  <thead>
		    <tr>
		      ...
		      <th class="bg-secondary text-white" scope="col">Nombre</th>
		      <th class="bg-success text-white" scope="col">Actividad</th>
		      <th class="bg-danger text-white" scope="col">Hora</th>
		      <th class="bg-warning text-white" scope="col">Fecha</th>
		    </tr>
		  </thead>
    </table>
</body>     
