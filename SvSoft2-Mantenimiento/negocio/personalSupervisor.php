    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-dark d-flex justify-content-center align-items-center flex-column a">
            <ul class="nav">
                ...
                <a class="btn btn-outline-light m-2 d-flex justify-content-center align-items-center" href="personalSupervisor.php"> 
...
<h1 class="Titulos">Datos del Personal</h1>
    <br></br>
    <div class="container">
      <a href="indexSupervisor.php" class="btn btn--1">Volver</a>
