                ...
                <div class="col">
                    <div class="seccion">
                        <div class="card glass">
                            <div class="card-content">
                                <div class="imagen">
                                    <img src="presentacion/css/fotos/Isabela.jpeg">
                                </div>
                                <div class="media-icons">
                                    <a href="https://github.com/isa417" target="_blank"
                                        class="icon-github texto"></a>
                                </div>
                                <div class="nombre-rol">
                                    <span class="nombre"> Isabella Castañeda Tellez</span>
                                    <span class="rol"> Patrones UI y UX </span>
                                </div>
                            </div>
                        </div>
                    </div>
